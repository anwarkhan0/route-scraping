  ...
  try {
    const zodSchema = z.object({
      routes: z
        ...
        .describe("An array of route sales mentioned in the text. where each route object must have title ir name, page url, location and other properties which are found."),
    });
